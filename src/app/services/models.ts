...
export { BorrowRequestResponse } from './models/borrow-request-response';
...
export { PageResponseBorrowRequestResponse } from './models/page-response-borrow-request-response';
